  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
          ...
          body:
              Consumer<LiveDataViewModel>(builder: (context, viewModel, child) {
            return TabBarView(
              children: [
                ListView(
                  children: [
                    _buildViewHeader(viewModel.isConnected),
                    _buildListTile('Rocket status ', viewModel.status),
                    _buildListTile('Current altitude ',
                        '${viewModel.altitude.toStringAsFixed(2)} m',
                        anim: viewModel.isValueDifferent((r) => r.altitude)),
                    _buildListTile('Current GPS altitude ',
                        '${viewModel.altitudeGPS.toStringAsFixed(2)} m',
                        anim: viewModel.isValueDifferent((r) => r.altitudeGPS)),
                    _buildListTile(
                        'Max altitude ', '${viewModel.maxAltitude} m',
                        anim: viewModel.isValueDifferent((r) => r.maxAltitude)),
                    _buildListTile('Apogee', '${viewModel.apogee} m',
                        anim: viewModel.isValueDifferent((r) => r.apogee)),
                    _buildListTile('Vertical velocity ',
                        '${viewModel.verticalVelocity.toStringAsFixed(3)} m/s',
                        anim: viewModel
                            .isValueDifferent((r) => r.verticalVelocity)),
                    _buildListTile('Max velocity ',
                        '${viewModel.maxVelocity.toStringAsFixed(3)} m/s',
                        anim: viewModel.isValueDifferent((r) => r.maxSpeed)),
                    _buildListTile('Velocity ',
                    ...
                    _buildListTile('Acceleration ',
                        ...
                        anim:
                            viewModel.isValueDifferent((r) => r.acceleration)),
                    _buildListTile('Gyroscope ',
                    ...
                    _buildListTile(
                        ...
                        anim:
                            viewModel.isValueDifferent((r) => r.batteryLevel)),
                    _buildListTile('GPS coordinates ',
